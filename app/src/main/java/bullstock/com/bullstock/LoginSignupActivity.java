						...
						new LogInCallback() {
							public void done(ParseUser user, ParseException e) {
								if (user != null) {
									...
									credentialsEditor.putString("username",usernametxt);
									credentialsEditor.apply();

									Toast.makeText(getApplicationContext(),credentialsSharedPref.getString("username","xxx"),Toast.LENGTH_SHORT).show();
